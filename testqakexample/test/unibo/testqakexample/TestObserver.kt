...
class TestObserver : CoapHandler {
    ...
    companion object {
        // ------------------------------ ACTORS DEFINITIONS --------------------------
        val ctxMap = mapOf(
            "ctxtesta" to Pair<String,Int>("localhost",8095),
            "ctxtestb" to Pair<String,Int>("localhost",8096),
			"ctxtestc" to Pair<String,Int>("localhost",8097),
        )
        val actorMap = mapOf(
            "componenta" to "ctxtesta",
            "componentb" to "ctxtestb",
            "componentc" to "ctxtestc",
        )
        // ----------------------------------------------------------------------------
