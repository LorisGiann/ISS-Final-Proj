		...
		return { //this:ActionBasciFsm
				state("wait") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t032",targetState="handle",cond=whenRequest("move"))
				}	 
				...
				state("req_forward_aclk") { //this:State
					...
					transition(edgeName="t035",targetState="set_new_dest_aclk",cond=whenRequest("move"))
				}	 
				...
				state("req_forward_clk") { //this:State
					...
					transition(edgeName="t039",targetState="set_new_dest_clk",cond=whenRequest("move"))
				}	 
				...
				state("req_u_turn") { //this:State
					...
					transition(edgeName="t042",targetState="req_u_turn",cond=whenReply("moveanswer"))
				}	 
				...
				state("reply") { //this:State
					...
					transition(edgeName="t044",targetState="handle",cond=whenRequest("move"))
				}	 
