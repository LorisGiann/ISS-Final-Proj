		...
		return { //this:ActionBasciFsm
				state("wait") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t045",targetState="req_halt",cond=whenRequest("moveruturn"))
				}	 
				state("req_halt") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t046",targetState="chk_halt",cond=whenReply("cmdanswer"))
				}	 
				...
				state("req_turn_1") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t047",targetState="chk_turn_1",cond=whenReply("cmdanswer"))
				}	 
				...
				state("req_turn_2") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t048",targetState="chk_turn_2",cond=whenReply("cmdanswer"))
				}	 
				...
				state("req_forward") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t049",targetState="chk_forward",cond=whenReply("cmdanswer"))
				}	 
				...
				state("req_final_turn") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t050",targetState="chk_final_turn",cond=whenReply("cmdanswer"))
				}	 
