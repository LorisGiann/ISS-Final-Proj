		...
		return { //this:ActionBasciFsm
				...
				state("work") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t159",targetState="execcmd",cond=whenDispatch("cmd"))
					transition(edgeName="t160",targetState="doStep",cond=whenRequest("step"))
					transition(edgeName="t161",targetState="handleObstacle",cond=whenDispatch("obstacle"))
					transition(edgeName="t162",targetState="endwork",cond=whenDispatch("end"))
				}	 
				...
				state("doStep") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t063",targetState="stepDone",cond=whenTimeout("local_tout_basicrobotlorisdavide_doStep"))   
					transition(edgeName="t064",targetState="stepFail",cond=whenDispatch("obstacle"))
				}	 
