		...
		return { //this:ActionBasciFsm
				...
				state("off") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t010",targetState="handle_update",cond=whenEvent("update_led"))
				}	 
				state("on") { //this:State
					action { //it:State
						println("$name in ${currentState.stateName} | $currentMsg")
					 ...
					 transition(edgeName="t011",targetState="handle_update",cond=whenEvent("update_led"))
				}	 
				state("blink_on") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t012",targetState="blink_off",cond=whenTimeout("local_tout_led_blink_on"))   
					transition(edgeName="t013",targetState="handle_update",cond=whenEvent("update_led"))
				}	 
				state("blink_off") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t014",targetState="blink_on",cond=whenTimeout("local_tout_led_blink_off"))   
