		...
		return { //this:ActionBasciFsm
				state("handle_prio") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t030",targetState="wait",cond=whenTimeout("local_tout_basicrobotwrapper_handle_prio"))   
					transition(edgeName="t031",targetState="halt",cond=whenDispatch("disable"))
				}	 
				state("halt") { //this:State
					action { //it:State
						println("$name in ${currentState.stateName} | $currentMsg")
						updateResourceRep( "basicrobotwrapper(halt)"  
						)
					}
					 transition(edgeName="t032",targetState="handle_prio",cond=whenDispatch("enable"))
				}	 
				state("wait") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t033",targetState="halt",cond=whenDispatch("disable"))
					transition(edgeName="t034",targetState="handle",cond=whenRequest("cmdsync"))
				}	 
				...
				state("forward_cmd") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t035",targetState="forward_halt",cond=whenDispatch("disable"))
					transition(edgeName="t036",targetState="collision",cond=whenEvent("info"))
				}	 
				state("forward_halt") { //this:State
					action { //it:State
						println("$name in ${currentState.stateName} | $currentMsg")
						updateResourceRep( "basicrobotwrapper(forward_halt)"  
						)
						forward("cmd", "cmd(h)" ,"basicrobot" ) 
					}
					 transition(edgeName="t037",targetState="forward_cmd",cond=whenDispatch("enable"))
					transition(edgeName="t038",targetState="collision",cond=whenEvent("info"))
				}	 
