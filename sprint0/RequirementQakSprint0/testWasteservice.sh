...
if [ -z "$1" ] ; then
    gradle -PmainClass=it.unibo.ctxservertest.MainCtxservertestKt jar
else
...
declare -a TEST_METHODS=(
    "testSprint0.TestWasteservice.test_2_accepted"
    "testSprint0.TestWasteservice.test_1_accepted_1_rejected"
)
