		...
		return { //this:ActionBasciFsm
				state("wait") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t039",targetState="handle",cond=whenRequest("moveto"))
				}	 
				state("handle") { //this:State
					action { //it:State
						...
						if( checkMsgContent( Term.createTerm("moveto(POSITION)"), Term.createTerm("moveto(POS)"), 
								...
								if(  DEST==CURRPOS 
								 ){answer("moveto", "movetoanswer", "movetoanswer(OK)","transporttrolley"   )  
								}
						}
				...
				state("req_pre_turn_aclk") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t040",targetState="chk_pre_turn_aclk",cond=whenReply("cmdanswer"))
				}	 
				...
				state("req_forward_aclk") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t041",targetState="chk_forward_aclk",cond=whenReply("cmdanswer"))
					transition(edgeName="t042",targetState="set_new_dest_aclk",cond=whenRequest("moveto"))
				}	 
				...
				state("req_post_turn_aclk") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t043",targetState="chk_post_turn_aclk",cond=whenReply("cmdanswer"))
				}	 
				...
				state("req_pre_turn_clk") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t044",targetState="chk_pre_turn_clk",cond=whenReply("cmdanswer"))
				}	 
				...
				state("req_forward_clk") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t045",targetState="chk_forward_clk",cond=whenReply("cmdanswer"))
					transition(edgeName="t046",targetState="set_new_dest_clk",cond=whenRequest("moveto"))
				}	 
				...
				state("req_post_turn_clk") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t047",targetState="chk_post_turn_clk",cond=whenReply("cmdanswer"))
				}	 
				...
				state("req_u_turn") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t048",targetState="chk_u_turn",cond=whenReply("moveruturnanswer"))
					transition(edgeName="t049",targetState="req_u_turn",cond=whenReply("movetoanswer"))
				}	 
				...
				state("reply") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t050",targetState="handle",cond=whenTimeout("local_tout_mover_reply"))   
					transition(edgeName="t051",targetState="handle",cond=whenRequest("moveto"))
				}	 
				state("error") { //this:State
					action { //it:State
						...
						answer("moveto", "movetoanswer", "movetoanswer(ERROR)","transporttrolley"   )  
