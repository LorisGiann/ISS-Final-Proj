		...
		return { //this:ActionBasciFsm
				state("wait") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t04",targetState="handle_req",cond=whenRequest("depositrequest"))
					transition(edgeName="t05",targetState="error",cond=whenDispatch("err"))
				}	 
				...
				state("req_depositaction") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t06",targetState="chk_depositaction",cond=whenReply("pickupdone"))
					transition(edgeName="t07",targetState="error",cond=whenDispatch("err"))
				}	 
