		...
		return { //this:ActionBasciFsm
				...
				state("activateTheSonar") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t070",targetState="handleSonarData",cond=whenEvent("alarmsonar"))
				...
				state("handleSonarData") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t072",targetState="handleSonarData",cond=whenEvent("alarmsonar"))
				...
				state("end") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t074",targetState="activateTheSonar",cond=whenDispatch("sonaractivate"))
				}	 
			}
		}
}
