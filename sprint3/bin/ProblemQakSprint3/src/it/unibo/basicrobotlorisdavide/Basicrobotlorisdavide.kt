		...
		return { //this:ActionBasciFsm
				...
				state("work") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t164",targetState="execcmd",cond=whenDispatch("cmd"))
					transition(edgeName="t165",targetState="doStep",cond=whenRequest("step"))
					transition(edgeName="t166",targetState="handleObstacle",cond=whenDispatch("obstacle"))
					transition(edgeName="t167",targetState="endwork",cond=whenDispatch("end"))
				}	 
				...
				state("doStep") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t068",targetState="stepDone",cond=whenTimeout("local_tout_basicrobotlorisdavide_doStep"))   
					transition(edgeName="t069",targetState="stepFail",cond=whenDispatch("obstacle"))
				}	 
