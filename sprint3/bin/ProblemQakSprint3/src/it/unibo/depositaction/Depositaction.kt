		...
		return { //this:ActionBasciFsm
				...
				state("wait") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t08",targetState="req_move_indoor",cond=whenRequest("depositaction"))
				}	 
				state("req_move_indoor") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t09",targetState="chk_move_indoor",cond=whenReply("movetoanswer"))
				}	 
				...
				state("req_pickup") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t010",targetState="chk_pickup",cond=whenReply("pickupanswer"))
				}	 
				...
				state("req_move_container") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t011",targetState="chk_move_container",cond=whenReply("movetoanswer"))
				}	 
				...
				state("req_dropout") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t012",targetState="chk_dropout",cond=whenReply("dropoutanswer"))
				}	 
				...
				state("next_move") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t013",targetState="move_home",cond=whenTimeout("local_tout_depositaction_next_move"))   
				...
				state("move_home") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t015",targetState="req_move_indoor",cond=whenRequest("depositaction"))
					transition(edgeName="t016",targetState="wait",cond=whenReply("movetoanswer"))
				}	 
			}
		}
}
