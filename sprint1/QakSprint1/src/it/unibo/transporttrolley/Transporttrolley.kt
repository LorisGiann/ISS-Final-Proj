		...
		return { //this:ActionBasciFsm
				...
				state("handle_cmd") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="toNewState22",targetState="moving_home",cond=whenDispatchGuarded("noMsg",{ tmp=="HOME"  
					}))
					transition(edgeName="toNewState23",targetState="moving_indoor",cond=whenDispatchGuarded("noMsg",{ tmp=="INDOOR"  
					}))
					transition(edgeName="toNewState24",targetState="moving_plasticbox",cond=whenDispatchGuarded("noMsg",{ tmp=="PLASTICBOX"  
					}))
					transition(edgeName="toNewState25",targetState="moving_glassbox",cond=whenDispatchGuarded("noMsg",{ tmp=="GLASSBOX"  
					}))
				}	 
				state("moving_home") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t026",targetState="moved_home",cond=whenTimeout("local_tout_transporttrolley_moving_home"))   
				...
				state("moved_home") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t028",targetState="handle_cmd",cond=whenRequest("move"))
				}	 
				state("moving_indoor") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t029",targetState="moved_indoor",cond=whenTimeout("local_tout_transporttrolley_moving_indoor"))   
				...
				state("moved_indoor") { //this:State
					...
					transition(edgeName="t032",targetState="pickUp",cond=whenRequest("pickup"))
				}	 
				state("moving_plasticbox") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t033",targetState="moved_plasticbox",cond=whenTimeout("local_tout_transporttrolley_moving_plasticbox"))   
				...
				state("moving_glassbox") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t037",targetState="moved_glassbox",cond=whenTimeout("local_tout_transporttrolley_moving_glassbox"))   
				...
				state("moved_glassbox") { //this:State
					...
					transition(edgeName="t040",targetState="dropOut",cond=whenRequest("dropout"))
				}	 
